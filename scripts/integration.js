...
const tokenAddress = '0x86d70E1D2F3420B88c961641dFe965DB471E875E';
pri_key = process.env.PRIV_KEY;
myAddress= '0x28e4d8fb82252f2d45f239da73e8B470eD4a17ed';
reciverAddress = '0xE66b28Bacc3bA1A742aF5cFFAC53F4A74C1e39f1';
async function interact(){
    web3 = await new Web3('https://data-seed-prebsc-1-s1.binance.org:8545');
    tokenContract = await new web3.eth.Contract(abi,tokenAddress);
...
async function sentToken(){
   ...
   // web3.eth.accounts.wallet.add(pri_key);
    tokenContract = await new web3.eth.Contract(abi,tokenAddress);
    myBalanceBefore = await tokenContract.methods.balanceOf(myAddress).call();
    ...
    myBalanceAlter = await tokenContract.methods.balanceOf(myAddress).call();
    myBalanceReciver = await tokenContract.methods.balanceOf(reciverAddress).call();
